...
public interface ProjectService {
    ...
    Project findProjectById(Long projectId, AuthenticatedUser authenticatedUser) throws ForbiddenProjectException;
    void deleteProjectById(Long projectId, AuthenticatedUser authenticatedUser) throws ForbiddenProjectException;
